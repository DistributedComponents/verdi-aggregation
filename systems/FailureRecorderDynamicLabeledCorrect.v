...
Require Import FailureRecorderDynamicLabeled.
...
- move {H1}.
  ...
  * destruct_update; repeat find_injection; last by eauto.
    find_rewrite.
    case (name_eq_dec from n') => H_dec; first by subst; find_rewrite_lem (ordered_dynamic_no_outgoing_uninitialized H _ H11).
    find_apply_lem_hyp NSetFacts.add_3 => //.
    by eauto.
- by find_apply_lem_hyp input_handlers_IOHandler; break_exists.
- by eauto.
Qed.
