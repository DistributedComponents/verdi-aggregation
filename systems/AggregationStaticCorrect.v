...
Module AggregationCorrect (Import NT : NameType)
...
forall net failed tr n, 
 step_ordered_failure_star (fail_msg_params := Aggregation_FailMsgParams) step_ordered_failure_init (failed, net) tr ->
 ~ In n failed ->
...
forall onet failed tr,
  step_ordered_failure_star (fail_msg_params := Aggregation_FailMsgParams) step_ordered_failure_init (failed, onet) tr -> 
  forall n n',
  ~ In n failed ->
