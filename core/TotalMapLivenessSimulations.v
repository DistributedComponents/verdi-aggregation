...
Theorem lb_step_o_f_tot_mapped_simulation_1 :
  forall net net' failed failed' lb tr,
    ...
    @lb_step_o_f _ labeled_multi_snd (map tot_map_name failed, tot_map_onet net) (tot_map_label lb) (map tot_map_name failed', tot_map_onet net') (map tot_map_trace_occ tr).
Proof.
move => net net' failed failed' lb tr H_step.
invcs H_step => //=.
- apply (@LSOF_deliver _ _ _ _ _ (@tot_map_msg _ _ _ _ msg_map m) (map (@tot_map_msg _ _ _ _ msg_map) ms) _ (tot_map_data d) (@tot_map_name_msgs _ _ _ _ _ msg_map l) (@tot_map_name _ _ _ _ name_map from)).
...
Theorem lb_step_o_d_f_tot_mapped_simulation_1 :
  forall net net' failed failed' lb tr,
    ...
    @lb_step_o_d_f _ labeled_multi_snd (map tot_map_name failed, tot_map_odnet net) (tot_map_label lb) (map tot_map_name failed', tot_map_odnet net') (map tot_map_trace_occ tr).
Proof.
move => net net' failed failed' lb tr H_step.
invcs H_step => //=.
- rewrite /tot_map_odnet /=.
  apply (@LSODF_deliver _ _ _ _ _ (@tot_map_msg _ _ _ _ msg_map m) (map (@tot_map_msg _ _ _ _ msg_map) ms) _ (tot_map_data d) (tot_map_data d') (@tot_map_name_msgs _ _ _ _ _ msg_map l) (@tot_map_name _ _ _ _ name_map from)) => //=.
  * exact: not_in_failed_not_in.
  * exact: in_failed_in. 
  * rewrite tot_map_name_inv_inverse.
    by find_rewrite.
...
{| evt_r_a := (map tot_map_name (fst e.(evt_r_a)), tot_map_onet (snd e.(evt_r_a))) ;
   evt_r_l := tot_map_label e.(evt_r_l) |}.
...
{| evt_tr_r_a := (map tot_map_name (fst e.(evt_tr_r_a)), tot_map_onet (snd e.(evt_tr_r_a))) ;
   evt_tr_r_l := tot_map_label e.(evt_tr_r_l) ;
   evt_tr_r_trace := map tot_map_trace_occ e.(evt_tr_r_trace) |}.
...
{| evt_r_a := (map tot_map_name (fst e.(evt_r_a)), tot_map_odnet (snd e.(evt_r_a))) ;
   evt_r_l := tot_map_label e.(evt_r_l) |}.
...
{| evt_tr_r_a := (map tot_map_name (fst e.(evt_tr_r_a)), tot_map_odnet (snd e.(evt_tr_r_a))) ;
   evt_tr_r_l := tot_map_label e.(evt_tr_r_l) ;
   evt_tr_r_trace := map tot_map_trace_occ e.(evt_tr_r_trace) |}.
